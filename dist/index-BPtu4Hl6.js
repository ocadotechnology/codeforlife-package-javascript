...
import { I as L } from "./Image-BDO6-axV.js";
...
import { p as C, a as q, t as z, s as M, j as g } from "./auth-Ds-898Jp.js";
import { L as u } from "./LinkButton-Csrg3yTU.js";
import { object as W, string as D } from "yup";
import { t as G } from "./schemas-DKgmBzcu.js";
const x = ({ boxProps: e, ...o }) => /* @__PURE__ */ r.jsx(_, { ...e, children: /* @__PURE__ */ r.jsx(O, { ...o }) }), T = ({
  ...
  ), j = o.map((s) => s.label), S = o.map((s) => s.children), d = o.map((s) => s.path);
  return f(() => {
    i(t);
  }, [t]), f(() => {
    const s = G(
      ...
      x,
      {
        ...
        children: /* @__PURE__ */ r.jsx(
          w,
          {
            ...
            children: j.map((s) => /* @__PURE__ */ r.jsx(B, { disableRipple: !0, label: s }, s))
          }
        )
      }
    ),
...
//# sourceMappingURL=index-BPtu4Hl6.js.map
