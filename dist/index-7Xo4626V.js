...
function ct({
  ...
  return t.map((e, i) => /* @__PURE__ */ u.jsxs(u.Fragment, { children: [
    e,
    i !== t.length - 1 ? /* @__PURE__ */ u.jsx(C, { ...o }) : void 0
  ] }));
}
function pt(t, o, e = "root", i = et) {
  if (i !== void 0) {
    const s = i[o];
...
//# sourceMappingURL=index-7Xo4626V.js.map
