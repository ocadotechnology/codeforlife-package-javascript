...
import { SESSION_METADATA_COOKIE_NAME as y } from "./settings/index.es.js";
import { buildCreateSlice as S, asyncThunkCreator as I } from "@reduxjs/toolkit";
import { j as f } from "./jsx-runtime-Dpn_P65e.js";
import { Stack as b, Typography as A, CircularProgress as E } from "@mui/material";
import "react";
import { b as T } from "./general-BJIOJXcG.js";
import "yup";
import { SyncProblem as j } from "@mui/icons-material";
const L = S({
  creators: { asyncThunk: I }
}), k = {
  isLoggedIn: !!m.get(y)
}, g = L({
  name: "session",
...
}), { login: H, logout: K } = g.actions, { selectIsLoggedIn: $ } = g.selectors, x = () => /* @__PURE__ */ f.jsxs(b, { alignItems: "center", alignContent: "center", children: [
  /* @__PURE__ */ f.jsx(j, { color: "error" }),
  /* @__PURE__ */ f.jsx(A, { color: "error.main", children: "Failed to sync data" })
] });
function O(e, r) {
...
//# sourceMappingURL=urls-HoIcuORM.js.map
