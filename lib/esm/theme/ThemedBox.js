...
var ThemedBox = function (_a) {
    ...
    var theme = responsiveFontSizes(createTheme(__assign(__assign({}, themeOptions), { components: __assign(__assign({}, themeOptions.components), { MuiTypography: __assign(__assign({}, (_b = themeOptions.components) === null || _b === void 0 ? void 0 : _b.MuiTypography), { styleOverrides: __assign(__assign({}, (_d = (_c = themeOptions.components) === null || _c === void 0 ? void 0 : _c.MuiTypography) === null || _d === void 0 ? void 0 : _d.styleOverrides), { root: function (_a) {
                        var ownerState = _a.ownerState;
                        return (__assign(__assign({}, getStyleOverrides(ownerState, 'MuiTypography')), fontStyleOverrides));
                    } }) }), MuiFormHelperText: __assign(__assign({}, (_e = themeOptions.components) === null || _e === void 0 ? void 0 : _e.MuiFormHelperText), { styleOverrides: __assign(__assign({}, (_g = (_f = themeOptions.components) === null || _f === void 0 ? void 0 : _f.MuiFormHelperText) === null || _g === void 0 ? void 0 : _g.styleOverrides), { root: function (_a) {
                        var ownerState = _a.ownerState;
                        return (__assign(__assign({}, getStyleOverrides(ownerState, 'MuiFormHelperText')), fontStyleOverrides));
                    } }) }), MuiLink: __assign(__assign({}, (_h = themeOptions.components) === null || _h === void 0 ? void 0 : _h.MuiLink), { styleOverrides: __assign(__assign({}, (_k = (_j = themeOptions.components) === null || _j === void 0 ? void 0 : _j.MuiLink) === null || _k === void 0 ? void 0 : _k.styleOverrides), { root: function (_a) {
                        var ownerState = _a.ownerState;
                        return (__assign(__assign({}, getStyleOverrides(ownerState, 'MuiLink')), fontStyleOverrides));
                    } }) }), MuiButton: __assign(__assign({}, (_l = themeOptions.components) === null || _l === void 0 ? void 0 : _l.MuiButton), { styleOverrides: __assign(__assign({}, (_o = (_m = themeOptions.components) === null || _m === void 0 ? void 0 : _m.MuiButton) === null || _o === void 0 ? void 0 : _o.styleOverrides), { contained: function (_a) {
                        var _b;
                        var ownerState = _a.ownerState;
                        ...
                        var ownerState = _a.ownerState;
                        return (__assign(__assign({}, getStyleOverrides(ownerState, 'MuiButton', 'outlined')), { border: "2px solid ".concat(bgcolor.contrastText), '&:hover': {
                                border: "2px solid ".concat(bgcolor.contrastText),
                                backgroundColor: 'transparent',
                                textDecoration: 'underline'
                            } }));
                    } }) }), MuiCheckbox: __assign(__assign({}, (_p = themeOptions.components) === null || _p === void 0 ? void 0 : _p.MuiCheckbox), { styleOverrides: __assign(__assign({}, (_r = (_q = themeOptions.components) === null || _q === void 0 ? void 0 : _q.MuiCheckbox) === null || _r === void 0 ? void 0 : _r.styleOverrides), { root: function (_a) {
                        var ownerState = _a.ownerState;
                        return (__assign(__assign({}, getStyleOverrides(ownerState, 'MuiCheckbox')), { color: "".concat(bgcolor.contrastText, " !important") }));
                    } }) }), MuiSvgIcon: __assign(__assign({}, (_s = themeOptions.components) === null || _s === void 0 ? void 0 : _s.MuiSvgIcon), { styleOverrides: __assign(__assign({}, (_u = (_t = themeOptions.components) === null || _t === void 0 ? void 0 : _t.MuiSvgIcon) === null || _u === void 0 ? void 0 : _u.styleOverrides), { root: function (_a) {
                        var ownerState = _a.ownerState;
