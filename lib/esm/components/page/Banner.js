...
var Banner = function (_a) {
    ...
    var contrastText = palette[bgcolor].contrastText;
    var _bgcolor;
    switch (bgcolor) {
        case 'primary':
        ...
        React.createElement(Section, { gridProps: { bgcolor: _bgcolor }, sx: { paddingY: 0 } },
            React.createElement(Stack, { direction: 'row', alignItems: 'center', justifyContent: textAlign, gap: 2 },
                React.createElement(Stack, { py: {
                    ...
                    React.createElement(Typography, { color: contrastText, variant: 'h4', mb: buttonProps !== undefined ? undefined : 0 }, subheader),
