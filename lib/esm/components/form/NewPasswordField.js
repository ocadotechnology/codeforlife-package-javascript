...
var NewPasswordField = function (_a) {
    ...
    var _d = React.useState(), validate = _d[0], setValidate = _d[1];
    ...
    passwordFieldProps.onKeyUp = wrap({
        after: function (event) {
            setValidate(YupString().test('matches-password', 'doesn\'t match password', function (repeatPassword) {
    ...
    return React.createElement(React.Fragment, null,
        ...
        React.createElement(TextField, __assign({ type: 'password', name: 'repeatPassword', required: true, validate: validate }, repeatPasswordFieldProps)));
};
