...
var CheckboxField = function (_a) {
    var formControlLabelProps = _a.formControlLabelProps, _b = _a.validate, validate = _b === void 0 ? YupBool() : _b, _c = _a.required, required = _c === void 0 ? false : _c, _d = _a.marginBottom, marginBottom = _d === void 0 ? formTypography.marginBottom : _d, name = _a.name, onChange = _a.onChange, otherCheckboxProps = __rest(_a, ["formControlLabelProps", "validate", "required", "marginBottom", "name", "onChange"]);
    ...
    var fieldConfig = {
        ...
        validate: function (value) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(validate instanceof BooleanSchema)) return [3 /*break*/, 5];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    return (React.createElement(Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (React.createElement(Stack, { direction: 'row', alignItems: 'center', marginLeft: '-12px', marginBottom: marginBottom, gap: 1 },
            React.createElement(FormControlLabel, __assign({ control: React.createElement(Checkbox, __assign({ defaultChecked: meta.initialValue, onChange: onChange }, otherCheckboxProps)) }, formControlLabelProps)),
            showError && ![undefined, ''].includes(meta.error) &&
                React.createElement(ClickableTooltip, { title: meta.error },
                    React.createElement(ErrorIcon, { className: 'checkbox-error' }))));
    }));
};
