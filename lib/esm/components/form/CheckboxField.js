...
var CheckboxField = function (_a) {
    var formControlLabelProps = _a.formControlLabelProps, _b = _a.stackProps, stackProps = _b === void 0 ? { gap: 1, style: { marginBottom: form.marginBottom } } : _b, _c = _a.validate, validate = _c === void 0 ? YupBool() : _c, _d = _a.required, required = _d === void 0 ? false : _d, name = _a.name, onChange = _a.onChange, otherCheckboxProps = __rest(_a, ["formControlLabelProps", "stackProps", "validate", "required", "name", "onChange"]);
    ...
    return (React.createElement(Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (React.createElement(Stack, __assign({ direction: 'row', alignItems: 'center' }, stackProps),
