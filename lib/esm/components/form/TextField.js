...
var TextField = function (_a) {
    var _b = _a.validate, validate = _b === void 0 ? YupString() : _b, _c = _a.required, required = _c === void 0 ? false : _c, name = _a.name, _d = _a.type, type = _d === void 0 ? 'text' : _d, _e = _a.value, value = _e === void 0 ? '' : _e, _f = _a.InputProps, InputProps = _f === void 0 ? {} : _f, onKeyUp = _a.onKeyUp, onBlur = _a.onBlur, sx = _a.sx, otherTextFieldProps = __rest(_a, ["validate", "required", "name", "type", "value", "InputProps", "onKeyUp", "onBlur", "sx"]);
    var theme = useTheme();
    ...
    return (React.createElement(Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (React.createElement(MuiTextField, __assign({ name: name, type: type, onKeyUp: onKeyUp, onBlur: onBlur, sx: sx, InputProps: __assign({ endAdornment: endAdornment }, otherInputProps) }, otherTextFieldProps)));
    }));
};
