...
var TextField = function (_a) {
    var validate = _a.validate, name = _a.name, type = _a.type, value = _a.value, _b = _a.InputProps, InputProps = _b === void 0 ? {} : _b, onKeyUp = _a.onKeyUp, onBlur = _a.onBlur, sx = _a.sx, otherTextFieldProps = __rest(_a, ["validate", "name", "type", "value", "InputProps", "onKeyUp", "onBlur", "sx"]);
    var theme = useTheme();
    var fieldConfig = {
        name: name,
        type: type,
