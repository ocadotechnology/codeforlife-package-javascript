...
var TextField = function (_a) {
    var _b = _a.validate, validate = _b === void 0 ? YupString() : _b, _c = _a.required, required = _c === void 0 ? false : _c, name = _a.name, _d = _a.type, type = _d === void 0 ? 'text' : _d, _e = _a.InputProps, InputProps = _e === void 0 ? {} : _e, onKeyUp = _a.onKeyUp, onBlur = _a.onBlur, sx = _a.sx, otherTextFieldProps = __rest(_a, ["validate", "required", "name", "type", "InputProps", "onKeyUp", "onBlur", "sx"]);
    var theme = useTheme();
    ...
    var fieldConfig = {
        ...
        validate: function (value) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(validate instanceof StringSchema)) return [3 /*break*/, 1];
                        try {
