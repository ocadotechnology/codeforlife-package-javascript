...
var TextField = function (_a) {
    ...
    return React.createElement(React.Fragment, null,
        React.createElement(_TextField, __assign({ validate: validate, split: split, name: name, onKeyUp: onKeyUp }, otherTextFieldProps)),
        repeat.map(function (_a) {
            ...
            return React.createElement(_TextField, __assign({ key: name, name: name, validate: validateRepeat, type: otherTextFieldProps.type }, (inheritProps && otherTextFieldProps), repeatTextFieldProps));
        }));
};
