...
var TextField = function (_a) {
    var validate = _a.validate, name = _a.name, type = _a.type, _b = _a.value, value = _b === void 0 ? '' : _b, _c = _a.InputProps, InputProps = _c === void 0 ? {} : _c, onKeyUp = _a.onKeyUp, onBlur = _a.onBlur, sx = _a.sx, otherTextFieldProps = __rest(_a, ["validate", "name", "type", "value", "InputProps", "onKeyUp", "onBlur", "sx"]);
    var theme = useTheme();
    var fieldConfig = {
        name: name,
        type: type,
        ...
        validate: function (value) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(validate instanceof YupSchema)) return [3 /*break*/, 1];
                        try {
