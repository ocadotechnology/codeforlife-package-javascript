...
var TextField = function (_a) {
    ...
    return (React.createElement(Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (React.createElement(MuiTextField, __assign({ value: meta.value, name: name, type: type, onKeyUp: onKeyUp, onBlur: onBlur, sx: sx, InputProps: __assign({ endAdornment: endAdornment }, otherInputProps) }, otherTextFieldProps)));
    }));
};
