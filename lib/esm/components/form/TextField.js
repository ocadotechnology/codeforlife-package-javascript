...
var TextField = function (_a) {
    var validate = _a.validate, split = _a.split, _b = _a.required, required = _b === void 0 ? false : _b, name = _a.name, _c = _a.type, type = _c === void 0 ? 'text' : _c, _d = _a.InputProps, InputProps = _d === void 0 ? {} : _d, onKeyUp = _a.onKeyUp, onBlur = _a.onBlur, otherTextFieldProps = __rest(_a, ["validate", "split", "required", "name", "type", "InputProps", "onKeyUp", "onBlur"]);
