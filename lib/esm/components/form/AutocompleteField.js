...
var AutocompleteField = function (_a) {
    ...
    return (React.createElement(Field, __assign({}, fieldConfig), function (_a) {
        ...
        var sx = textFieldProps.sx, _c = textFieldProps.InputProps, InputProps = _c === void 0 ? {} : _c, onBlur = textFieldProps.onBlur, otherTextFieldProps = __rest(textFieldProps, ["sx", "InputProps", "onBlur"]);
        ...
        return (React.createElement(Autocomplete, __assign({ options: options, renderInput: function (params) { return (React.createElement(TextField, __assign({}, params, otherTextFieldProps, { value: meta.value, sx: sx, onBlur: onBlur, InputProps: __assign({ endAdornment: endAdornment }, otherInputProps) }))); }, onChange: function (_, value) {
                flushSync(function () {
