...
export var fetch = fetchBaseQuery({
...
export function injectCsrfToken(fetch, args, api, serviceName) {
    if (serviceName === void 0) { serviceName = SERVICE_NAME; }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (error !== undefined) {
                        window.location.href = "".concat(PORTAL_BASE_URL, "/error/500");
                    }
                    csrfToken = Cookies.get(cookieName);
...
export function handleResponseError(result) {
    // Check if errors.
    ...
    if (result.error.status === 400 &&
        ...
        window.location.href = "".concat(PORTAL_BASE_URL, "/login/teacher");
    }
    else {
        // Catch-all error pages by status-code.
        window.location.href = "".concat(PORTAL_BASE_URL, "/error/").concat([
            403,
            404
...
export function parseResponseBody(result) {
...
var baseQuery = function (args, api, extraOptions) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, injectCsrfToken(fetch, args, api)];
            case 1:
                _a.sent();
