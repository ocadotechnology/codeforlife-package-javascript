...
var ThemedBox = function (_a) {
    ...
    var _v = _a.options, options = _v === void 0 ? _1.themeOptions : _v, _w = _a.withIcons, withIcons = _w === void 0 ? false : _w, userType = _a.userType, children = _a.children, sx = _a.sx, otherBoxProps = __rest(_a, ["options", "withIcons", "userType", "children", "sx"]);
    var bgcolor;
    var circleColor;
    var hexagonColor;
    switch (userType) {
