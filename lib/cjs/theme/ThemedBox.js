...
var ThemedBox = function (_a) {
    ...
    var _v = _a.options, options = _v === void 0 ? _1.themeOptions : _v, _w = _a.withShapes, withShapes = _w === void 0 ? false : _w, userType = _a.userType, bgcolor = _a.bgcolor, children = _a.children, sx = _a.sx, otherBoxProps = __rest(_a, ["options", "withShapes", "userType", "bgcolor", "children", "sx"]);
    var circleColor;
    var hexagonColor;
    var contrastText;
    switch (userType) {
        case 'teacher':
            bgcolor = bgcolor !== null && bgcolor !== void 0 ? bgcolor : colors_1.primary[400];
            circleColor = 'tertiary';
            hexagonColor = 'secondary';
            contrastText = palette_1.default.primary.contrastText;
            break;
        case 'student':
            bgcolor = bgcolor !== null && bgcolor !== void 0 ? bgcolor : colors_1.tertiary[500];
            circleColor = 'secondary';
            hexagonColor = 'primary';
            contrastText = palette_1.default.tertiary.contrastText;
            break;
        case 'independent':
            bgcolor = bgcolor !== null && bgcolor !== void 0 ? bgcolor : colors_1.secondary[500];
            circleColor = 'primary';
            hexagonColor = 'tertiary';
            contrastText = palette_1.default.secondary.contrastText;
            break;
    }
