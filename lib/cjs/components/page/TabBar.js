...
var TabBar = function (_a) {
    var header = _a.header, tabs = _a.tabs, originalPath = _a.originalPath, _b = _a.initialValue, initialValue = _b === void 0 ? 0 : _b;
    var params = (0, react_router_dom_1.useParams)();
    var navigate = (0, react_router_dom_1.useNavigate)();
    var _c = react_1.default.useState(initialValue < 0
        ? 0
        : initialValue >= tabs.length
            ? tabs.length - 1
            : initialValue), value = _c[0], setValue = _c[1];
    ...
    return react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(Section_1.default, { gridProps: { bgcolor: colors_1.primary[300] }, sx: { paddingY: '6px' }, className: 'flex-center' },
            react_1.default.createElement(material_1.Tabs, { value: value, onChange: function (_, value) {
                ...
                return react_1.default.createElement(material_1.Tab, { key: label, label: label });
            }))),
        children[value]);
};
