...
var AutocompleteField = function (_a) {
    ...
    return (react_1.default.createElement(formik_1.Field, __assign({}, fieldConfig), function (_a) {
        ...
        onBlur = (0, helper_1.wrap)({
            after: function () { setShowError(true); }
        }, onBlur);
        return (react_1.default.createElement(material_1.Autocomplete, __assign({ options: options, defaultValue: meta.initialValue, renderInput: function (params) {
                ...
                return (react_1.default.createElement(material_1.TextField, __assign({}, params, otherTextFieldProps, { sx: sx, onBlur: onBlur, InputProps: __assign({ endAdornment: endAdornment }, otherInputProps) })));
