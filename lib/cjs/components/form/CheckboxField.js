...
var CheckboxField = function (_a) {
    var formControlLabelProps = _a.formControlLabelProps, _b = _a.validate, validate = _b === void 0 ? (0, yup_1.bool)() : _b, _c = _a.required, required = _c === void 0 ? false : _c, name = _a.name, onChange = _a.onChange, otherCheckboxProps = __rest(_a, ["formControlLabelProps", "validate", "required", "name", "onChange"]);
