...
var CheckboxField = function (_a) {
    var formControlLabelProps = _a.formControlLabelProps, _b = _a.stackProps, stackProps = _b === void 0 ? {} : _b, _c = _a.iconProps, iconProps = _c === void 0 ? {} : _c, _d = _a.validate, validate = _d === void 0 ? (0, yup_1.bool)() : _d, name = _a.name, _e = _a.value, value = _e === void 0 ? false : _e, onChange = _a.onChange, otherCheckboxProps = __rest(_a, ["formControlLabelProps", "stackProps", "iconProps", "validate", "name", "value", "onChange"]);
    var fieldConfig = {
        name: name,
        value: value,
        type: 'checkbox',
