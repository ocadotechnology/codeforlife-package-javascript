...
var CheckboxField = function (_a) {
    var formControlLabelProps = _a.formControlLabelProps, _b = _a.stackProps, stackProps = _b === void 0 ? {} : _b, _c = _a.validate, validate = _c === void 0 ? (0, yup_1.bool)() : _c, _d = _a.required, required = _d === void 0 ? false : _d, name = _a.name, onChange = _a.onChange, otherCheckboxProps = __rest(_a, ["formControlLabelProps", "stackProps", "validate", "required", "name", "onChange"]);
