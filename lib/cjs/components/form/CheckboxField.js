...
var CheckboxField = function (_a) {
    ...
    return (react_1.default.createElement(formik_1.Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (react_1.default.createElement(material_1.Stack, __assign({ direction: 'row', justifyContent: 'center' }, stackProps),
            ...
            meta.error !== undefined && meta.error !== '' &&
                react_1.default.createElement(ClickableTooltip_1.default, { title: meta.error },
                    react_1.default.createElement(material_1.Icon, __assign({}, iconProps),
                        react_1.default.createElement(icons_material_1.Error, { color: iconProps.color })))));
    }));
};
