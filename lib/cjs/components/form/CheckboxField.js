...
var CheckboxField = function (_a) {
    var formControlLabelProps = _a.formControlLabelProps, _b = _a.stackProps, stackProps = _b === void 0 ? {} : _b, _c = _a.iconProps, iconProps = _c === void 0 ? {} : _c, _d = _a.validate, validate = _d === void 0 ? (0, yup_1.bool)() : _d, name = _a.name, onChange = _a.onChange, otherCheckboxProps = __rest(_a, ["formControlLabelProps", "stackProps", "iconProps", "validate", "name", "onChange"]);
    var fieldConfig = {
        name: name,
        type: 'checkbox',
        validate: function (value) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(validate instanceof yup_1.BooleanSchema)) return [3 /*break*/, 1];
                        try {
    ...
    return (react_1.default.createElement(formik_1.Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (react_1.default.createElement(material_1.Stack, __assign({ direction: 'row' }, stackProps),
            react_1.default.createElement(material_1.FormControlLabel, __assign({ control: react_1.default.createElement(material_1.Checkbox, __assign({ value: meta.value, onChange: onChange }, otherCheckboxProps)) }, formControlLabelProps)),
            meta.error !== undefined && meta.error !== '' &&
                react_1.default.createElement(ClickableTooltip_1.default, { title: meta.error },
                    react_1.default.createElement(material_1.Icon, __assign({}, iconProps),
                        react_1.default.createElement(icons_material_1.Error, null)))));
    }));
};
