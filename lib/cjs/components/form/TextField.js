...
var TextField = function (_a) {
        ...
        var fieldConfig = {
            ...
            validate: function (value) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(validate instanceof yup_1.Schema)) return [3 /*break*/, 1];
                            try {
    ...
    return react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(TextField, __assign({ validate: validate, split: split, name: name, onKeyUp: onKeyUp }, otherTextFieldProps)),
        repeat.map(function (textFieldProps) {
            return react_1.default.createElement(TextField, __assign({ key: textFieldProps.name, validate: validateRepeat }, otherTextFieldProps, textFieldProps));
        }));
};
