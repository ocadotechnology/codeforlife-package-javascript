...
var TextField = function (_a) {
    var _b = _a.validate, validate = _b === void 0 ? (0, yup_1.string)() : _b, _c = _a.required, required = _c === void 0 ? false : _c, name = _a.name, _d = _a.type, type = _d === void 0 ? 'text' : _d, _e = _a.InputProps, InputProps = _e === void 0 ? {} : _e, onKeyUp = _a.onKeyUp, onBlur = _a.onBlur, sx = _a.sx, otherTextFieldProps = __rest(_a, ["validate", "required", "name", "type", "InputProps", "onKeyUp", "onBlur", "sx"]);
    ...
    return (react_1.default.createElement(formik_1.Field, __assign({}, fieldConfig), function (_a) {
        ...
        return (react_1.default.createElement(material_1.TextField, __assign({ value: meta.value, name: name, type: type, onKeyUp: onKeyUp, onBlur: onBlur, sx: sx, InputProps: __assign({ endAdornment: endAdornment }, otherInputProps) }, otherTextFieldProps)));
    }));
};
