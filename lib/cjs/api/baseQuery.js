...
exports.parseResponseBody = exports.handleResponseError = exports.injectCsrfToken = exports.parseRequestBody = void 0;
...
function injectCsrfToken(args, api) {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (args.method !== undefined &&
                        ...
                        return [2 /*return*/];
                    csrfToken = js_cookie_1.default.get('csrftoken');
