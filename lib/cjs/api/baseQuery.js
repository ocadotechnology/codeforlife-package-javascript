...
exports.parseResponseBody = exports.handleResponseError = exports.injectCsrfToken = exports.parseRequestBody = exports.fetch = void 0;
var query_1 = require("@reduxjs/toolkit/query");
var js_cookie_1 = __importDefault(require("js-cookie"));
var qs_1 = __importDefault(require("qs"));
var env_1 = require("../env");
var general_1 = require("../helpers/general");
exports.fetch = (0, query_1.fetchBaseQuery)({
...
function injectCsrfToken(fetch, args, api, serviceName) {
    if (serviceName === void 0) { serviceName = env_1.SERVICE_NAME; }
    return __awaiter(this, void 0, void 0, function () {
        var cookieName, csrfToken, error;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (args.method !== undefined &&
                        ...
                        return [2 /*return*/];
                    cookieName = "".concat(serviceName, "_csrftoken");
                    csrfToken = js_cookie_1.default.get(cookieName);
                    if (!(csrfToken === undefined)) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    if (error !== undefined) {
                        window.location.href = "".concat(env_1.PORTAL_BASE_URL, "/error/500");
                    }
                    csrfToken = js_cookie_1.default.get(cookieName);
                ...
                case 2:
                    ...
                    args.body = __assign(__assign({}, (typeof args.body !== 'object' || args.body === null ? {} : args.body)), { csrfmiddlewaretoken: csrfToken });
                    return [2 /*return*/];
            }
        });
    });
...
var baseQuery = function (args, api, extraOptions) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, injectCsrfToken(exports.fetch, args, api)];
            case 1:
                _a.sent();
                parseRequestBody(args);
                return [4 /*yield*/, (0, exports.fetch)(args, api, extraOptions)];
            case 2:
                result = _a.sent();
